...
extern const double g_dPI           ;   //!< Double precision: PI 
extern const double g_d2PI          ;   //!< Double precision: PI * 2 
extern const double g_dPIDiv2       ;   //!< Double precision: PI / 2 
extern const double g_dPIDiv4       ;   //!< Double precision: PI / 4 
extern const double g_dInvPI        ;   //!< Double precision: 1 / PI
extern const double g_dE            ;   //!< Double precision: E
extern const double g_dDegToRad     ;   //!< Double precision: Degrees to Radians
extern const double g_dRadToDeg     ;   //!< Double precision: Radians to Degrees
extern const double g_dHuge         ;   //!< Double precision: Huge float number
extern const double g_dEpsilon      ;   //!< Double precision: Tiny float (almost zero)
extern const double g_dInvEpsilon   ;   //!< Double precision: Huge float (1/epsilon)
extern const double g_dPosInfinity  ;   //!< Double precision: Positive infinity
extern const double g_dNegInfinity  ;   //!< Double precision: Negative infinity
extern const double g_dFoV          ;   //!< Double precision: Field of View
extern const double g_dZNear        ;   //!< Double precision: Near clipping distance
extern const double g_dZFar         ;   //!< Double precision: Far clipping distance
...
template< class T >
T SinDeg ( const T& angle )
{
    return sin( angle * g_dDegToRad );
}

template< class T >
T CosDeg ( const T& angle )
{
    return cos( angle * g_dDegToRad );
}

template< class T >
T TanDeg ( const T& angle )
{
    return tan( angle * g_dDegToRad );
}

template< class T >
T AsinDeg ( const T& value )
{
    return g_dRadToDeg * asin( value );
}

template< class T >
T AcosDeg ( const T& value )
{
    return g_dRadToDeg * acos( value );
}

template< class T >
T AtanDeg ( const T& value )
{
    return g_dRadToDeg * atan( value );
}

template< class T >
T Atan2Deg ( const T& x1, const T& x2 )
{
    return g_dRadToDeg * atan2( x1, x2 );
}
