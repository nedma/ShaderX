...
typedef int WindowIdleProc(void);
typedef void WindowNotifyProc(WPARAM wParam, LPARAM lParam);
typedef void WindowPaintProc(void);
...
public:
  ...
  CVector3f *GetMouseScreenCoordinates(void)
  {
    return &m_pAbsolute;
  };

  // get relative coordinates
  CVector3f *GetMouseRelativeCoordinates(void)
  {
    return &m_pRelative;
  };
