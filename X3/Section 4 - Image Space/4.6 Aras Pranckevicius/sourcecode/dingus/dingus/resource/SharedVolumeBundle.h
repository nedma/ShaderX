...
{
public:
	void registerVolume( CResourceId const& id, const IVolumeCreator::TSharedPtr& creator );
...
protected:
	virtual void deleteResource( CD3DVolumeTexture& resource ) { delete &resource; }
