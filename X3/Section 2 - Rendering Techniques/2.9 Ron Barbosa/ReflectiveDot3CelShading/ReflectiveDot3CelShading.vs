...
float4x4	view_matrix:		register(c9);	// View matrix
...
VS_OUTPUT vs_main(VS_INPUT inData)
{
	...
	// Transform the vertex normal into view space.  The view
	// space normal is required for sampling texels from the
	// spherical environment map.
	Out.vCSNorm  = mul(view_matrix, inData.vNorm);
