...
public:
    ...
    friend  CVector3        operator    *               ( const CVector3&   a_vecScale
                                                        , const CVector3&   a_vecSource     )               ;
    friend  CVector3        operator    /               (       float       a_fScale        
                                                        , const CVector3&   a_vecSource     )               ;
...
//
//*****************************************************************************
inline CVector3 operator * ( const CVector3& a_vecScale, const CVector3& a_vecSource )
{
    return CVector3 ( a_vecSource[0] * a_vecScale[0]
                    , a_vecSource[1] * a_vecScale[1]
                    , a_vecSource[2] * a_vecScale[2]
                    );
}
